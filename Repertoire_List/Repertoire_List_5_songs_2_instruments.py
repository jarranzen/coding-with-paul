#script picks 5 random songs from an array and chooses between either guitar or keyboard to play them on.
#the script then prints the song name and the instrument that it is being played on.
...
# select 5 random songs from the songs list
def select_songs(songs):
    return random.sample(songs, 5)


# choose 1 random instrument from the instruments list
